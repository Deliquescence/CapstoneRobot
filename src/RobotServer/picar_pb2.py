...
_MOVECAMERA = _descriptor.Descriptor(
  name='MoveCamera',
  full_name='CapstoneRobot.MoveCamera',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='horizontal_angle', full_name='CapstoneRobot.MoveCamera.horizontal_angle', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vertical_angle', full_name='CapstoneRobot.MoveCamera.vertical_angle', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
MoveCamera = _reflection.GeneratedProtocolMessageType('MoveCamera', (_message.Message,), dict(
  ...
  __module__ = 'picar_pb2'
  # @@protoc_insertion_point(class_scope:CapstoneRobot.MoveCamera)
  ))
...
_PICAR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CameraControl',
    full_name='CapstoneRobot.PiCar.CameraControl',
    index=5,
    containing_service=None,
    input_type=_MOVECAMERA,
    output_type=_EMPTY,
    serialized_options=None,
  ),
])
